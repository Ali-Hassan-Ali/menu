            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('dashboard.categorys.create') }}" class="btn btn-primary">
                            <i class="fa fa-plus"></i> @lang('dashboard.create')
                        </a>

                        <form method="post" action="{{ route('dashboard.categorys.bulk_delete') }}" style="display: inline-block;">
                            @csrf
                            @method('delete')
...
@push('scripts')
    ...
    <script>
        ...
        let dataTable = $('#data-table').DataTable({
            ...
            ajax: {
                url: '{{ route('dashboard.categorys.data') }}',
            },
            columns: [
