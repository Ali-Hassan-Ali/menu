...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('sliders.sliders')</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ route('dashboard.sliders.bulk_delete') }}" style="display: inline-block;">
                            @csrf
                            @method('delete')
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="data-table" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('sliders.name')</th>
                                    <th>@lang('sliders.image')</th>
...
@push('scripts')
    ...
    <script>
        ...
        let dataTable = $('#data-table').DataTable({
            ...
            ajax: {
                url: '{{ route('dashboard.sliders.data') }}',
            },
            columns: [
